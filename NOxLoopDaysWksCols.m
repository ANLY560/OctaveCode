% Loop to create matrix with NOx daily averages
NOx_dailyAvg = zeros(1:365,1);
for i = 1:365,
   temp = mean(NOxmatx(1:24,i));
   NOx_dailyAvg(i) = temp;
end
...
ylabel('Average Measured Levels of NOx')
